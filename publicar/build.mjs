...
const T = EN
  ...
  : {
      ...
      splashAlt: "Capa de Engenharia de RAG: o título em branco e âmbar sobre fundo azul-escuro com malha de blueprint, e abaixo um diagrama do sistema em dois caminhos — indexação (corpus, chunk, índice) e consulta (pergunta, busca, rerank, geração) — com a legenda \"recuperar barato, reordenar caro, responder fundamentado\".",
      ...
      pdfLivro: "pdf/engenharia-de-rag.pdf",
      mdLivro: "md/engenharia-de-rag.md",
      pdfLivroTitulo: "Livro completo em PDF",
      mdLivroTitulo: "Livro completo em Markdown (bom para LLMs)",
      continueLendo: "Continue lendo",
      retomar: "Retomar ▶",
      trilha: [
        ["01-fundamentos.html", "Trilha · 1", "Fundamentos", "Vocabulário e a herança de Information Retrieval."],
        ["02-anatomia-do-sistema.html", "Trilha · 2", "A arquitetura", "Os componentes e as topologias, antes das técnicas."],
        ["06-busca.html", "Trilha · 3", "Recuperação", "Como se acha: busca, rerank, consulta, estrutura."],
        ["15-geracao-fundamentada.html", "Trilha · 4", "Geração", "O \"G\" do RAG: fundamentar, citar, abster-se."],
      ],
      partesCartao: new Set(["Abertura", "Parte I — A arquitetura", "Parte II — O corpus", "Parte III — Recuperação"]),
...
const COMPANION_CAPS = [
  ...
  { chave: "arquitetura", rotulo: "Mapa dos componentes", libera: 2 },
  { chave: "topologia", rotulo: "Arquiteturas de referência", libera: 3 },
  { chave: "corpus", rotulo: "Corpus curado", libera: 4 },
  { chave: "chunking", rotulo: "Corte e representação", libera: 5 },
  { chave: "busca", rotulo: "Busca híbrida", libera: 6 },
  { chave: "reranking", rotulo: "Reranking", libera: 7 },
  { chave: "consulta", rotulo: "Entendimento da consulta", libera: 8 },
  { chave: "avancada", rotulo: "Recuperação avançada", libera: 9 },
  { chave: "estruturada", rotulo: "Pergunta global", libera: 10 },
  { chave: "fundamentacao", rotulo: "Geração fundamentada", libera: 15 },
  { chave: "rag_agentico", rotulo: "RAG agêntico", libera: 18 },
  { chave: "conversacional", rotulo: "RAG conversacional", libera: 19 },
  { chave: "orcamento", rotulo: "Orçamento de janela", libera: 20 },
  { chave: "evals", rotulo: "Avaliação do sistema", libera: 21 },
  { chave: "seguranca", rotulo: "Corpus não confiável", libera: 22 },
  { chave: "custo", rotulo: "Custo e cache", libera: 23 },
];
