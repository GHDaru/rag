...
//   docs/pdf/engenharia-de-rag.pdf  — livro completo (capa + tudo)
...
await imprimir(docHtml(corpo, capaLivro), resolve(PDFS, EN ? "harness-engineering.pdf" : "engenharia-de-rag.pdf"), sumario.titulo);
