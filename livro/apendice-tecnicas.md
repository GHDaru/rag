...
>
> **Estado:** o catálogo cobre as técnicas que os capítulos da edição 0.2 mencionam. A expansão — cada ficha com fonte primária e condição experimental, e as 58 técnicas de prompting da taxonomia de referência (*The Prompt Report*) na Parte IV — é a **rodada 5** do [ROADMAP](https://github.com/GHDaru/rag/blob/main/ROADMAP.md).
