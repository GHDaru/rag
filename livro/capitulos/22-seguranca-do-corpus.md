...
- **O risco deixou de ser teórico, e tem número de registro** — **CVE-2025-32711**, descrito no registro oficial como *"Ai command injection in M365 Copilot allows an unauthorized attacker to disclose information over a network"* ([NVD](https://nvd.nist.gov/vuln/detail/CVE-2025-32711), consultado em 2026-08-13; pontuação-base 7,5 na avaliação do NIST). O que ele mostra é a tese do capítulo em produção: o conteúdo recuperado — ali, um e-mail — chegou ao modelo como instrução, e o dano foi **exfiltração**, não resposta errada. A edição anterior deste livro afirmava que "há registro público de vulnerabilidades" **sem citar um identificador**; era retórica, e agora tem número.
