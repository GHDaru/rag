...
| Pergunta global | **sumarização hierárquica / comunidades** | indexação pesada | muito alto, uma vez |
...
- **Múltiplas consultas** — decompor uma pergunta composta em várias, buscar cada uma, unir os resultados. É a ponte natural para o cap. 11.
...
### 3. Grafo: quando vale e quando é sobre-engenharia
